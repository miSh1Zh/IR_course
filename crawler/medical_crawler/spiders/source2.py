...
class Source2Spider(scrapy.Spider):
    """Spider для второго источника медицинских статей
    
    TODO: Заменить на реальный источник медицинских статей
    Примеры возможных источников:
    - medvestnik.ru
    - medportal.ru
    - cyberleninka.ru (раздел медицина)
    """
    
    name = 'source2'
    allowed_domains = ['example-medical-source2.ru']  # TODO: заменить
    
    start_urls = ['https://example-medical-source2.ru/']  # TODO: заменить
