...
while true; do
    ...
    # 2. journaldoctor
    if [ "$JOURNALDOCTOR_TIME" -gt 0 ]; then
        echo ""
    ...
    # 6. clinickrasnodar
    if [ "$CLINICKRASNODAR_TIME" -gt 0 ]; then
        echo ""
